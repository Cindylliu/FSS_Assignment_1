...
> Given the following code, generate me a colorful and clearer visualization.

I used ChatGPT for both tasks 1.3 and 1.4 (Total number of defects per month & Defect Commits per Month for Top 2 Files), both for visualization generation and refactorization.
...
> Structure and clean the following code, xxx.

ChatGPT then reorganized the code into multiple small functions, allowing me to implement and reuse different parts without complex interactions. I then continued based on the structure and added other functions.
